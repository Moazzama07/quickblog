    ...
    return (
        <tr className='order-y border-gray-300'>
            <td className='px-6 py-4'>
                <b className='font-medium text-gray-60'>Blog</b>: {blog.title}
                <br />
                <br />
                <b className='font-medium text-gray-60'>Name </b>: {comment.name}
                <br />
                <b className='font-medium text-gray-60'>Comment</b>: {comment.content}
            </td>
