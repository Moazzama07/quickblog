    ...
    return (
        <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
            <div className='text-center mt-20 mb-8'>
                ...
                <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque eveniet architecto numquam, laboriosam animi magnam!</p>
                ...
                <form onSubmit={onSubmitHandler} className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>
                    ...
                    <button type="submit" className='bg-primary text-white cursor-pointer px-8 py-2 m-1.5 rounded hover:scale-105 transition-all'>Search</button>
                </form>
            </div>
