...
export const dashboard_data = {
  ...
  drafts: blog_data.filter(b => !b.isPublished).length,
  recentBlog: [
    {
      _id: blog_data[0]._id,
      title: blog_data[0].title,
      subTitle: blog_data[0].subTitle,
      description: blog_data[0].description,
      category: blog_data[0].category,
      image: blog_data[0].image,
      isPublished: blog_data[0].isPublished,
      createdAt: "2025-09-20T10:30:00Z",
    },
    {
      _id: blog_data[1]._id,
      title: blog_data[1].title,
      subTitle: blog_data[1].subTitle,
      description: blog_data[1].description,
      category: blog_data[1].category,
      image: blog_data[1].image,
      isPublished: blog_data[1].isPublished,
      createdAt: "2025-09-21T14:45:00Z",
    },
    {
      _id: blog_data[2]._id,
      title: blog_data[2].title,
      subTitle: blog_data[2].subTitle,
      description: blog_data[2].description,
      category: blog_data[2].category,
      image: blog_data[2].image,
      isPublished: blog_data[2].isPublished,
      createdAt: "2025-09-22T09:15:00Z",
    },
    {
      _id: blog_data[3]._id,
      title: blog_data[3].title,
      subTitle: blog_data[3].subTitle,
      description: blog_data[3].description,
      category: blog_data[3].category,
      image: blog_data[3].image,
      isPublished: blog_data[3].isPublished,
      createdAt: "2025-09-23T11:45:00Z",
    },
    {
      _id: blog_data[4]._id,
      title: blog_data[4].title,
      subTitle: blog_data[4].subTitle,
      description: blog_data[4].description,
      category: blog_data[4].category,
      image: blog_data[4].image,
      isPublished: blog_data[4].isPublished,
